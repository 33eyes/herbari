...
function custom_post_example() { 
	...
	register_post_type( 'plants', /* (http://codex.wordpress.org/Function_Reference/register_post_type) */
		// let's now add all the options for this post type
		array( 'labels' => array(
			'name' => __( 'Plants', 'bonestheme' ), /* This is the Title of the Group */
			'singular_name' => __( 'Plant', 'bonestheme' ), /* This is the individual type */
			'all_items' => __( 'All Plants', 'bonestheme' ), /* the all items menu item */
			'add_new' => __( 'Add New', 'bonestheme' ), /* The add new menu item */
			'add_new_item' => __( 'Add New Plant', 'bonestheme' ), /* Add New Display Title */
			'edit' => __( 'Edit', 'bonestheme' ), /* Edit Dialog */
			'edit_item' => __( 'Edit Plants', 'bonestheme' ), /* Edit Display Title */
			'new_item' => __( 'New Plant', 'bonestheme' ), /* New Display Title */
			'view_item' => __( 'View Plant', 'bonestheme' ), /* View Display Title */
			'search_items' => __( 'Search Plants', 'bonestheme' ), /* Search Custom Type Title */ 
			'not_found' =>  __( 'Nothing found in the Database.', 'bonestheme' ), /* This displays if there are no entries yet */ 
			'not_found_in_trash' => __( 'Nothing found in Trash', 'bonestheme' ), /* This displays if there is nothing in the trash */
			'parent_item_colon' => ''
			), /* end of arrays */
			'description' => __( 'This is the Plants custom post type', 'bonestheme' ), /* Custom Type Description */
			'public' => true,
			...
			'rewrite'	=> array( 'slug' => 'plants', 'with_front' => false ), /* you can specify its url slug */
			'has_archive' => 'plants', /* you can rename the slug here */
	...
	register_taxonomy_for_object_type( 'category', 'plants' );
	/* this adds your post tags to your custom post type */
	register_taxonomy_for_object_type( 'post_tag', 'plants' );
	...
	*/
	...
	register_taxonomy( 'custom_cat', 
		array('plants'), /* if you change the name of register_post_type( 'plants', then you have to change this */
